  ...
  return (
    <div className="p-5 lg:p-20 flex flex-col lg:flex-row gap-10">
      <div className="w-full md:w-1/2 lg:w-[30%] space-y-2">
        ...
        <div>
          <div>
            <p className="font-bold text-xl"> {products.product?.seller?.businessDetails.businessName}</p>
      ...
      <section className="w-full md:w-1/2 lg:w-[70%]">
        <h1 className="font-semibold text-2xl pb-4 text-gray-700">Write Your Review & Give Ratings</h1>
        <ReviewForm />
      </section>
    </div>
  );
