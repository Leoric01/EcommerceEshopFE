  ...
  return {
    ...
    async getUserProfile(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ResultAccountDetailDto>
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["UserControllerApi.getUserProfile"]?.[
    ...
    async updateSeller(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResultUser>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateSeller(
        userUpdateReqDto,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["UserControllerApi.updateSeller"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const UserControllerApiFactory = function (
  ...
  return {
    ...
    updateSeller(
      userUpdateReqDto: UserUpdateReqDto,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ResultUser> {
      return localVarFp
        .updateSeller(userUpdateReqDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
